 ...
 * way — and the committed one is the 2026-09-10 run: 995 hosts carrying 1,298
 * mounts and 139 anchored inserts, which the join puts on **969** records'
 * `mounts`, **285** records' `anchor` and **10** records' `modelledIn`. The
